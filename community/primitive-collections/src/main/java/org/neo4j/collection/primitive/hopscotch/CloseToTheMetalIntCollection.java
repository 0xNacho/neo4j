...
public abstract class CloseToTheMetalIntCollection<VALUE> extends CloseToTheMetalHopScotchHashingAlgorithm<VALUE>
        implements PrimitiveIntCollection
{
    public CloseToTheMetalIntCollection( NumberArrayFactory factory, int itemsPerEntry, int itemsPerKey, VALUE nullValue )
    {
